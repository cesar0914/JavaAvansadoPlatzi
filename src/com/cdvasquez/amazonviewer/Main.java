package com.cdvasquez.amazonviewer;
...
import com.cdvasquez.amazonviewer.model.Book;
import com.cdvasquez.amazonviewer.model.Chapter;
import com.cdvasquez.amazonviewer.model.Film;
import com.cdvasquez.amazonviewer.model.Magazine;
import com.cdvasquez.amazonviewer.model.Movie;
import com.cdvasquez.amazonviewer.model.Serie;
import com.cdvasquez.makereport.Report;
import com.cdvasquez.util.AmazonUtil;
 ...
 * respectivos Chapters, Books y Magazines. Te permite generar reportes generales y con fecha del día.
 * <p>
 * Existen algunas reglas como todos los elementos pueden ser visualizados o leídos a excepción de 
 * las Magazines, estas sólo pueden ser vistas a modo de exposición sin ser leídas.
 * 
 * @author cdvasquez
 * @version 1.1
 * @since 2020
...
public class Main {
	...
	public static void makeReport() {
		...
		movies.stream()
		.filter(movie -> movie.getIsVeiwed())
		.forEach(movie -> contentReport.append(movie.toString() + "\n"));
		
		//Predicate<Serie> seriesViewed = serie -> serie.getIsVeiwed();		
		//Consumer<Serie> seriesEach = serie -> contentReport.append(serie.toString() + "\n");
		Consumer<Serie> seriesEach = serie -> {
			ArrayList<Chapter> chapters = serie.getChapters();
			chapters.stream().
			filter(chapter -> chapter.getIsVeiwed())
